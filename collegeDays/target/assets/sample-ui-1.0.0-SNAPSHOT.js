    ...
    .config(function config($stateProvider) {
        $stateProvider.state('home', {
            ...
            views: {
                "main": {
                    controller: 'HomeCtrl',
                    templateUrl: 'html-templates/src/app/home/home.tpl.html'
                }
            },
...
/**
 * Created by singhs64 on 8/6/2015.
 */
...
angular.module('home')
    ...
    .controller('HomeCtrl', function HomeCtrl($scope, $parse) {
...
/**
 * Created by singhs64 on 8/7/2015.
 */

angular.module('userDashboard').controller('userDashboardCtrl', function ($scope){

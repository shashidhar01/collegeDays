...
module.exports = {
     ...
     * development and the `built_dir` folder is where our app resides once it's
     * completely built.
     */
    src_dir: "./",
    build_dir: 'build',
    ...
    vendor_files: {
        js: [
            ...
            'vendor/html5-boilerplate/js/vendor/modernizr-2.6.2.min.js'
        ],
        css: ['vendor/bootstrap/dist/css/*.css'],
        assets: [
